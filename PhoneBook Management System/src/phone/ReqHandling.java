...
import javax.swing.*;
public class ReqHandling extends JFrame implements ActionListener{
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource()==submit)
		{
			...
			int up=con.smt.executeUpdate("update contact_info set name='"+input1+"', phone="+input2+",email='"+input3+"',category='"+input4+"' where phone='"+condition+"'");
	...
	{
		long dumber=9512648523;
		new ReqHandling(dumber).setVisible(true);
	}*/
}
